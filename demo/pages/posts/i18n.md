...
为了使 [Valaxy](https://github.com/valaxyjs/valaxy) 成为一个国际化的项目，i18n 是必不可少的。
...
In order to make [Valaxy](https://github.com/valaxyjs/valaxy) an international project, i18n is essential.
